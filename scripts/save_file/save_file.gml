...
function save_file(filename){
	...
	temp = json_stringify(global.phrase_volume)
	ini_write_string("Other","Volume",temp)
	temp = json_stringify(global.phrase_panning)
	ini_write_string("Other","Balance",temp)
